	...
	public function register_taxonomies() {
		...
		if ( $custom_taxes ) {
			...
			foreach( $custom_taxes as $tax_id ) {
				...
				$args = array(
					'labels'                => $labels,
					'description'           => wp_strip_all_tags( $meta[ '_ptu_description' ][0] ?? '' ),
