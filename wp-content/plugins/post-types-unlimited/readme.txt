...
* Fixed duplocate Menu Name option for taxonomies.

= 1.0.8 =
* Added PTU_VERSION constant added.

= 1.0.7 =
* Updated Tested up to version 6.0.1
* Updated Metabox class has been updated so you can pass a callback function name for select choices.

= 1.0.6 =
* Updated Tested up to version 5.9.3
* Updated Requires PHP version to 7.4
* Updated Slimmed down various code using newer PHP methods.
