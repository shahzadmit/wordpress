<?php 
/**
 * Template Name: Flow Heater Page */
 get_header();
  $args = array(  
        'category' => 'news',
        'post_status' => 'publish',
            ...
            <div class="row">
                <div class="col-12 p-0 d-flex justify-content-center align-items-center news_header_block">
                    <div class="text-center fixed_wrapper-4">
                        <h1 class="h_product"><?php echo get_field('news_page_title');?></h1><br/>
                        <p><?php echo get_field('new_page_desc');?></p>
                    </div>
                </div>
            </div>
        </div>      
<div class="home_news news_page">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="welcome_header text-center"><?php echo get_field('news_page_title');?></h3>
                    </div>
